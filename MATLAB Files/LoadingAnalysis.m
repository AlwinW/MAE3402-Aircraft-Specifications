...
L_Aero = real(L_Aero); %% Only 80% of the aerodynamic lift actually acts on the wings themselves
...
I2_2 = z2_2*(r2_2.^3)./12;
I_2 = I1_2 + I2_2;
I = (I_1 + (2*r1*z1 + r2*z2)*(0.083)^2 + I_2 + (2*r1_2.*z1_2 + r2_2*z2_2)*(0.04518)^2);
...
Vol_Total_Ribs = mean(Area_Ribs).*0.00225.*Rib_Num.*4420.*0.85 % 2.25mm thickness, with a typical/conservative 85%% filled volume %
