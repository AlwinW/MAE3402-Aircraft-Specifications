...
hold on
plot(0:0.01:a, Moment, 'm')
title('Moment distribution over the wing, n = -1.5')
xlabel('Root chord to tip chord')
ylabel('Bending Moment')
%% Net Force Determination %%
Force = L_Aero - L_Batt - L_Wing - L_Eng;
figure
plot(0:0.01:a, 100*Force, 'r')
title('Force distribution over the wing, n = -1.5')
xlabel('Root chord to tip chord')
ylabel('Net Force')
